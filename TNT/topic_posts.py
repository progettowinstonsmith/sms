...
class TOPIC_POSTS(Transformer):
    ...
    SUB = 'topic'
    TABLE = 'bb_topics'
    DB_SQL = "SELECT P.topic_id, P.pid as topic_last_post_id FROM Trck_topics T, Trck_posts P WHERE P.topic_id = T.tid AND T.last_post = P.post_date AND T.last_poster_id = P.author_id AND T.forum_id = 51 "
